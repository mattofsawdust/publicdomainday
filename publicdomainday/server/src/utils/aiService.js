      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "text",
              text: "Please analyze this image comprehensively. Pay special attention to creating a diverse and specific set of 15-20 keywords that could be used to find this image in a search."
            }
          ]
        }
      ],
